  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed dark:border-r inset-y-0 z-10 hidden shadow-sm h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-7 border-none shadow-none! hover:bg-foreground/10", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        " md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        className,
      )}
      {...props}
    />
